 ...
 * 2016-05-04T19:07:05.441+10:00
 * Generated source version: 3.1.6
 * 
 */
@WebServiceClient(name = "Weather", 
                  wsdlLocation = "file:/E:/dev/adpatraDev/workspace/CCIntegration/src/resources/wsdl/weatherService.wsdl",
...
public class Weather extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/dev/adpatraDev/workspace/CCIntegration/src/resources/wsdl/weatherService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Weather.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/E:/dev/adpatraDev/workspace/CCIntegration/src/resources/wsdl/weatherService.wsdl");
        }
        WSDL_LOCATION = url;
    }
